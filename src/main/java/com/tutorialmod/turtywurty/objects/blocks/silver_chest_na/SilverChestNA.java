...
public class SilverChestNA extends BlockContainer implements IHasModel
{
	...
	{
		playerIn.openGui(TutorialMod.instance, Reference.GUI_SILVER_CHEST_NA, worldIn, pos.getX(), pos.getY(), pos.getZ());
		return true;
	}
