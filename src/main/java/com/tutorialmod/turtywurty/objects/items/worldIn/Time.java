...
public class Time extends Item implements IHasModel
{
	...
	{
		if(worldIn.getWorldTime() != 27000)
		{
			worldIn.setWorldTime(27000);
		}
		else if(worldIn.getWorldTime() != 5000)
		{
			worldIn.setWorldTime(5000);
		}
		else
		{
			worldIn.setWorldTime(12000);
		}
